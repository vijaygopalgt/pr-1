...
export default function TestimonialsSection() {
  ...
  return (
    <section className="w-full py-20 bg-black  border-t border-neutral-800">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <h2 className="text-[36px] font-bold text-[#D70E0E] mb-10 flex items-center gap-2">
          <img
                    src={AR}
                        alt="Gym Training"
                        className=" w-[74px] h-[74px] "></img> Testimonials
        </h2>

        <div className="grid md:grid-cols-2 gap-10 items-start">
          {/* Left Text */}
          <div className="max-w-md">
            <p className="italic text-[36px] italic leading-loose text-white">
              “What our Member Says! <br />
              <span className="text-[#D70E0E]">Real experiences</span> from our{" "}<br />
              <span className="text-[#D70E0E]">valued members</span>”
            </p>
            <p className="text-[36px] italic mt-15 text-white">Give Your own Review!</p>
            <button className="bg-[#D70E0E] w-[199px] h-[45px] px-6 py-2 mt-12 rounded-full text-[16px] items-center">
              Write Review
            </button>
          </div>
...
<div className="relative w-full">
  ...
  <div className="block lg:hidden overflow-x-auto scrollbar-hide">
    <div className="flex gap-[39px] min-w-[333px] pr-4">
        ...
        >
          <div className="bg-[#121212] border border-gray-600 rounded-[20px] p-[25px_24px] h-full text-center shadow-lg">
            <img
              src={item.image}
              alt={item.name}
              className="w-[273px] h-[160px]  mb-4"
            />
            ...
            <p className="text-white mt-10 text-xl">{item.review}</p>
          </div>
        </div>
      ))}
    </div>
  ...
  <div className="hidden lg:block">
    <div className="overflow-hidden w-[870px]">
      <div
